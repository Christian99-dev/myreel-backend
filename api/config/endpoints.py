...
path_config = EndpointConfig({
    ...
    '/group/{group_id}/role':             {"GET": EndpointInfo(role=RoleEnum.EXTERNAL, has_subroles=True)},
    '/group/{group_id}/groupExists':      {"GET": EndpointInfo(role=RoleEnum.EXTERNAL, has_subroles=True)},
    '/group/{group_id}/listMembers':      {"GET": EndpointInfo(role=RoleEnum.GROUP_MEMBER, has_subroles=True)},    
