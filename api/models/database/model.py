...
class Slot(Base):
    ...
    song_id: Mapped[int] = mapped_column(ForeignKey('song.song_id', ondelete='CASCADE'), nullable=False)
...
class Edit(Base):
    ...
    song_id: Mapped[int] = mapped_column(ForeignKey('song.song_id', ondelete='CASCADE'), nullable=False)
    created_by: Mapped[int] = mapped_column(ForeignKey('user.user_id', ondelete='CASCADE'), nullable=False)
