...
def test_role_external(db_session_filled: Session):
    ...
    # no user given
    roleTesterHasAccess(Role(admintoken="wrong",    userid=-99,     groupid=group_id_1,      editid=1,        db_session=db_session_filled),  RoleEnum.EXTERNAL)
    roleTesterHasAccess(Role(admintoken="wrong",    userid=None,    groupid=group_id_1,      editid=1,        db_session=db_session_filled),  RoleEnum.EXTERNAL)
    
    # wrong group    
    roleTesterHasAccess(Role(admintoken="wrong",    userid=4,     groupid=group_id_1,    editid=1,        db_session=db_session_filled),  RoleEnum.EXTERNAL)
    roleTesterHasAccess(Role(admintoken="wrong",    userid=4,     groupid=group_id_1,    editid=None,     db_session=db_session_filled),  RoleEnum.EXTERNAL)
    roleTesterHasAccess(Role(admintoken="wrong",    userid=5,     groupid=group_id_1,    editid=None,     db_session=db_session_filled),  RoleEnum.EXTERNAL)
...
def test_role_group_creator(db_session_filled: Session):
    roleTesterHasAccess(Role(admintoken=None,   userid=1,   groupid=group_id_1,  editid=None, db_session=db_session_filled), RoleEnum.GROUP_CREATOR)
...
def test_role_group_member(db_session_filled: Session):
    roleTesterHasAccess(Role(admintoken=None,   userid=2,   groupid=group_id_1,  editid=None, db_session=db_session_filled), RoleEnum.GROUP_MEMBER)   

def test_role_always_highest(db_session_filled: Session):  
    admin_token = os.getenv("ADMIN_TOKEN")    
    
    # ADMIN 
    roleTesterHasAccess(Role(admintoken=admin_token,   userid=1,        groupid=group_id_1,      editid=None, db_session=db_session_filled), RoleEnum.ADMIN)  # ALSO GROUP_CREATOR
    ...
    roleTesterHasAccess(Role(admintoken=admin_token,   userid=2,        groupid=group_id_1,      editid=None, db_session=db_session_filled), RoleEnum.ADMIN)  # ALSO GROUP_MEMBER
    
    # GROUP_CREATOR 
    roleTesterHasAccess(Role(admintoken=None,           userid=1,        groupid=group_id_1,     editid=1,    db_session=db_session_filled), RoleEnum.GROUP_CREATOR)  # ALSO EDIT_CREATOR
