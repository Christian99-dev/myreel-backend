...
from api.utils.database.test_model import test_model  # Adjust import path as per your project structure

def test_session_isolation(db_session_empty: Session):
...
def test_session_isolation_other(db_session_empty: Session):
