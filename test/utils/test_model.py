...
test_model = Model(
    ...
    edits=[
        Edit(edit_id=1, song_id=1, created_by=1, group_id=group_id_1, name="Edit 1 of Group 1", isLive=False),
        Edit(edit_id=2, song_id=2, created_by=3, group_id=group_id_1, name="Edit 2 of Group 1", isLive=False),
        Edit(edit_id=3, song_id=3, created_by=2, group_id=group_id_1, name="Edit 3 of Group 1", isLive=False),
        Edit(edit_id=4, song_id=1, created_by=4, group_id=group_id_2, name="Edit 1 of Group 2", isLive=False),
        Edit(edit_id=5, song_id=2, created_by=6, group_id=group_id_2, name="Edit 2 of Group 2", isLive=False),
        Edit(edit_id=6, song_id=3, created_by=6, group_id=group_id_2, name="Edit 3 of Group 2", isLive=False),
        Edit(edit_id=7, song_id=1, created_by=7, group_id=group_id_3, name="Edit 1 of Group 3", isLive=False),
        Edit(edit_id=8, song_id=2, created_by=9, group_id=group_id_3, name="Edit 2 of Group 3", isLive=False),
        Edit(edit_id=9, song_id=3, created_by=8, group_id=group_id_3, name="Edit 3 of Group 3", isLive=False)
    ]
)