...
def fill_test_model(db_session: Session):
    ...
    invitations = [Invitation(invitation_id=invitation.invitation_id, group_id=invitation.group_id, token=invitation.token, 
                   ...
                   for invitation in test_model.invitations]
    ...
    login_requests = [LoginRequest(user_id=login_request.user_id, pin=login_request.pin, 
                      ...
                      for login_request in test_model.login_requests]
    ...
    occupied_slots = [OccupiedSlot(user_id=occupied_slot.user_id, slot_id=occupied_slot.slot_id, 
                      ...
                      for occupied_slot in test_model.occupied_slots]
